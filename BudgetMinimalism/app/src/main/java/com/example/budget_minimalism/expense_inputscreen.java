...
public class expense_inputscreen extends AppCompatActivity {
    ...
    private FloatingActionButton expenseBack;   //create object for back button
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expenseBack = (FloatingActionButton) findViewById(R.id.expenseBack);
        expenseBack.setOnClickListener(new View.OnClickListener() {
            @Override
